...
from wtforms import StringField, PasswordField, SubmitField, IntegerField, IntegerRangeField
...
class ProfileForm(FlaskForm):
    ...
    tuition = IntegerRangeField(label='Tuition Range ($):', validators=[NumberRange(min=1, max=100000), DataRequired()])
    tuition_display = IntegerField(default=100000, validators=[NumberRange(min=1, max=100000), DataRequired()])
